...
public class scene_behavior : MonoBehaviour
{
    ...
    public GameObject chasing_monster, chasing_monster_ocean, chasing_monster_ocean_2;
    ...
    // for equipment room
    public GameObject con_suit, flashlight, harpoon, moonpool_flag, circuit_panel, circuit_panel_2, AIroomDoor;

    public GameObject tutorial, monster_sample, monster_sample_2;
    private int scene_index, player_choice;
    private bool scene_flag, sample_collected, panel_key_collected;
        ...
        switch(scene_index){
            ...
            case 13: // main lab scene
                ...
                if(Vector3.Distance(player.transform.position, lab_computer.transform.position) <= 1.0f && dialogue_box.GetComponent<Dialogue>().active == false){
                    ...
                    if(Input.GetKeyDown(KeyCode.Z)){
                        dialogue_box.SetActive(true);
                        // play computer audio
                        lab_computer.GetComponent<AudioSource>().Play();
                        // start tutorial
                ...
                if(Vector3.Distance(player.transform.position, broken_usb.transform.position) <= 1.0f && dialogue_box.GetComponent<Dialogue>().active == false){
                    ...
                    if(Input.GetKeyDown(KeyCode.Z)){
                        dialogue_box.SetActive(true);
                        // play USB audio
                        broken_usb.GetComponent<AudioSource>().Play();
                        // start tutorial
            ...
            case 17: // equipment room
                ...
                if(Vector3.Distance(player.transform.position, con_suit.transform.position) <= 1.0f && dialogue_box.GetComponent<Dialogue>().active == false){
                    ...
                    if(Input.GetKeyDown(KeyCode.Z)){
                        // play suit audio
                        // con_suit.GetComponent<AudioSource>().Play();
                        // suit dialoge
                        string[] lines = con_suit.GetComponent<dialogue_item>().sentences;
                        string[] speakers = con_suit.GetComponent<dialogue_item>().speakers;
                        string choices = con_suit.GetComponent<dialogue_item>().choices;
                        dialogue_box.GetComponent<Dialogue>().choices = choices;
                        dialogue_box.GetComponent<Dialogue>().speakers = speakers;
                        dialogue_box.GetComponent<Dialogue>().sentences = lines;
                        dialogue_box.SetActive(true);
                ...
                if(Vector3.Distance(player.transform.position, harpoon.transform.position) <= 1.3f && dialogue_box.GetComponent<Dialogue>().active == false){
                    // if input key "Z" is pressed collect harpoon
                    if(Input.GetKeyDown(KeyCode.Z)){
                        // play harpoon audio
                        // harpoon.GetComponent<AudioSource>().Play();
                        // harpoon dialoge
                        string[] lines = harpoon.GetComponent<dialogue_item>().sentences;
                        string[] speakers = harpoon.GetComponent<dialogue_item>().speakers;
                        string choices = harpoon.GetComponent<dialogue_item>().choices;
                        dialogue_box.GetComponent<Dialogue>().choices = choices;
                        dialogue_box.GetComponent<Dialogue>().speakers = speakers;
                        dialogue_box.GetComponent<Dialogue>().sentences = lines;
                        dialogue_box.SetActive(true);
                ...
                if(Vector3.Distance(player.transform.position, flashlight.transform.position) <= 1.0f && dialogue_box.GetComponent<Dialogue>().active == false){
                    ...
                    if(Input.GetKeyDown(KeyCode.Z)){
                        // play flashlight audio
                        // flashlight.GetComponent<AudioSource>().Play();
                        // flashlight dialoge
                        string[] lines = flashlight.GetComponent<dialogue_item>().sentences;
                        string[] speakers = flashlight.GetComponent<dialogue_item>().speakers;
                        string choices = flashlight.GetComponent<dialogue_item>().choices;
                        dialogue_box.GetComponent<Dialogue>().choices = choices;
                        dialogue_box.GetComponent<Dialogue>().speakers = speakers;
                        dialogue_box.GetComponent<Dialogue>().sentences = lines;
                        dialogue_box.SetActive(true);
                ...
                if(con_suit_done == true && harpoon_done == true && flashlight_done == true && dialogue_box.GetComponent<Dialogue>().active == false){
                    // INTRA dialogue
            ...
            case 19: // moon pool
                ...
                objective_screen.SetActive(true);
                objective_text.text = "-> Fix a circuit panel";
                // if player near circuit panel trigger dialoge - hard path
                ...
                if(Vector3.Distance(player.transform.position, circuit_panel_2.transform.position) <= 1.0f && dialogue_box.GetComponent<Dialogue>().active == false){
                    ...
                    if(Input.GetKeyDown(KeyCode.Z) && panel_key_collected == true){
                        ...
                        string[] speakers = circuit_panel_2.GetComponent<dialogue_item>().speakers;
                        string choices = circuit_panel_2.GetComponent<dialogue_item>().choices;
                        dialogue_box.GetComponent<Dialogue>().choices = choices;
                        dialogue_box.GetComponent<Dialogue>().speakers = speakers;
                        dialogue_box.GetComponent<Dialogue>().sentences = lines;
                        dialogue_box.SetActive(true);
                ...
                // picking up panel key
                if(Vector3.Distance(player.transform.position, panel_key.transform.position) <= 1.0f && dialogue_box.GetComponent<Dialogue>().active == false){
                    // if input key "Z" is pressed collect suit
                    if(Input.GetKeyDown(KeyCode.Z)){
                        // panel key audio
                        panel_key.GetComponent<AudioSource>().Play();
                        // panel key dialoge
                        string[] lines = panel_key.GetComponent<dialogue_item>().sentences;
                        string[] speakers = panel_key.GetComponent<dialogue_item>().speakers;
                        string choices = panel_key.GetComponent<dialogue_item>().choices;
                        dialogue_box.GetComponent<Dialogue>().choices = choices;
                        dialogue_box.GetComponent<Dialogue>().speakers = speakers;
                        dialogue_box.GetComponent<Dialogue>().sentences = lines;
                        dialogue_box.SetActive(true);
            ...
            case 20: // cutscene
                ...
                if(dialogue_box.GetComponent<Dialogue>().active == true){
                    ...
                    if(scene_flag == true){
                        ...
                        if(ocean_easy_path == true){
                            if(Physics2D.OverlapCircle(player.transform.position, 1.0f, LayerMask.GetMask("OceanCorridor"))){
                                chasing_monster_ocean_2.SetActive(true);
                            }
                        ...
                        if(Physics2D.OverlapCircle(player.transform.position, 1.0f, LayerMask.GetMask("OceanExit")) && dialogue_box.GetComponent<Dialogue>().active == false){
                            ...
                            if(Input.GetKeyDown(KeyCode.Z)){
                                ...
                                chasing_monster_ocean_2.SetActive(false);
                                // go to scene 21
                                scene_index = 21;
                            }
                        }
